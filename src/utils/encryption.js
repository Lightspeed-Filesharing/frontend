...
export const createKeys = async (sodium) => {
    // Creates cryptography keys derived from a randomly generated password and salt.
...
export const encrypt = async (sodium, unencryptedData, key, nonce = null) => {
    // Encrypts data using the keys and a randomly generated nonce.
    if (!nonce) {
...
export const decrypt = async (
    ...
    nonce,
    key,
    disableStringification = false
) => {
    // Decrypts encrypted data using a provided nonce.
